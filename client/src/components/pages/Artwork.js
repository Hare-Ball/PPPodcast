...
function Artwork() {
  return (
    <Container>
      <Row>
        <Col> <img id= "instagram" alt= "Opportunity Artwork 1" src={opportunity1}></img></Col>
        <Col> <img id= "instagram" alt= "Opportunity Artwork 2" src={opportunity2}></img></Col>
        <Col> <img id= "instagram" alt= "Opportunity Artwork 3" src={opportunity3}></img></Col>
      </Row>
      <Row>
        <Col> <img id= "instagram" alt= "Invictus Artwork 1" src={invictus1}></img></Col>
        <Col> <img id= "instagram" alt= "Invictus Artwork 2" src={invictus2}></img></Col>
        <Col> <img id= "instagram" alt= "Invictus Artwork 3" src={invictus3}></img></Col>
        <Col> <img id= "instagram" alt= "Invictus Artwork 4" src={invictus4}></img></Col>
      </Row>
    </Container>
  );
}
